...
df %>%
  group_by(tag_id) %>%
  summarise(accelerations = counter(na.omit(acceleration), 3, timestamp, 0.5), 
...
df %>%
  group_by(tag_id) %>%
  summarise(accelerations = accDistance(na.omit(acceleration), 2, timestamp, total_distance, 0.5))
