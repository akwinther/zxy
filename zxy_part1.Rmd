...
df %>%
  group_by(tag_id) %>%
  summarise(accelerations = counter(na.omit(acceleration), 2, timestamp, 0.5), 
...
df %>%
  group_by(tag_id) %>%
  summarise(accelDist = metricDistance(na.omit(acceleration), 2, timestamp, total_distance, 0.85),
...
df %>%
  group_by(tag_id) %>%
  summarise(sprintMeters1_5 = sprintDistance(speed, 7, timestamp, total_distance, 0, 1, 5),
            sprintMeters6_10 = sprintDistance(speed, 7, timestamp, total_distance, 0, 6, 10),
            sprintMeters11_15 = sprintDistance(speed, 7, timestamp, total_distance, 0, 11, 15),
            sprintMeters16_20 = sprintDistance(speed, 7, timestamp, total_distance, 0, 16, 20),
            sprintMeters21_25 = sprintDistance(speed, 7, timestamp, total_distance, 0, 21, 25),
            sprintMeters26_30 = sprintDistance(speed, 7, timestamp, total_distance, 0, 26, 30),
            sprintMeters31_35 = sprintDistance(speed, 7, timestamp, total_distance, 0, 31, 35),
            sprintMeters36_40 = sprintDistance(speed, 7, timestamp, total_distance, 0, 36, 40),
            sprintMeters41plus = sprintDistance(speed, 7, timestamp, total_distance, 0, 41, 80)) %>%
